...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var test, zone, controller, pump, tempSensor;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    zone = _a.sent();
                    return [4 /*yield*/, prisma.controller.upsert({
                            where: { name: 'main' },
                            update: {},
                            create: {
                                name: 'main',
                ...
                case 3:
                    controller = _a.sent();
                    return [4 /*yield*/, prisma["switch"].upsert({
                ...
                case 4:
                    pump = _a.sent();
                    return [4 /*yield*/, prisma.pin.upsert({
                            where: { pin: 22 },
                            update: {},
                            create: {
                                pin: 22,
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, prisma.sensor.upsert({
